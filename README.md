...
3. I have an idea for how to generate different ascii outputs depending on the target font, analyzing it and building a gradient from it from scratch.
4. Speed upgrades? Maybe Rayon, but we'll see. It's pretty fast as is.